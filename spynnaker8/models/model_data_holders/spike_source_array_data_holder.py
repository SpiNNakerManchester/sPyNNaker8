...
class SpikeSourceArrayDataHolder(DataHolder):
    def __init__(
            ...
            port=SpikeSourceArray.non_pynn_default_parameters['port'],
            tag=SpikeSourceArray.non_pynn_default_parameters['tag'],

            ip_address=SpikeSourceArray.non_pynn_default_parameters[
                'ip_address'],

            board_address=SpikeSourceArray.non_pynn_default_parameters[
                'board_address'],
            ...
            label=SpikeSourceArray.non_pynn_default_parameters[
                'label'],
