...
class WeightDependenceCyclic(_BaseClass):
    def __init__(self,
        ...
        w_min_excit2 = _defaults['w_min_excit2'], w_max_excit2 = _defaults['w_max_excit2'],
            A_plus_excit2 = _defaults['A_plus_excit2'], A_minus_excit2 = _defaults['A_minus_excit2'],
        ...
        super(WeightDependenceCyclic, self).__init__(
