...
class ParamsSetAsList(BaseTestCase):
    ...
    def do_run(self):
        ...
        self.assertEqualss(cm, pop_1.get("cm"))
        self.assertEqualss(i_off, pop_1.get("i_offset"))
        self.assertEqualss(tau_m, pop_1.get("tau_m"))
        self.assertEqualss(tau_re, pop_1.get("tau_refrac"))
        self.assertEqualss(tau_syn_e, pop_1.get("tau_syn_E"))
        self.assertEqualss(tau_syn_i, pop_1.get("tau_syn_I"))
        self.assertEqualss(v_reset, pop_1.get("v_reset"))
        self.assertEqualss(v_rest, pop_1.get("v_rest"))
