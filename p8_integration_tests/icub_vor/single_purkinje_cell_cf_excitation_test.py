...
cf_src.record('spikes')
purkinje_cell.record("all")

pf_weights = []
p.run(1000)

cf_src_data = cf_src.get_data('spikes')
...
F = Figure(
    ...
    Panel(cf_src_data.segments[0].spiketrains,
