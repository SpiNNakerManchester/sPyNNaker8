...
#                                       w_cur, atol=0.001))
    ...
    runtime:        runtime
    exp_wgt:        correct weight for this test
    spike_times:    input spikes
    spike_times:    driving spikes
    test_name:    test name string to print in report
    """
    def run_one_test(self, init_vals, runtime, exp_wgt, spike_times, spike_times2,  test_name):
        p.setup(1)
        ...
        runtime = runtime
        exp_wgt = exp_wgt* self.shared_params['w_mult']
        ...
        # Post-plastic-synapse population
        cell_params = {"i_offset":0.0,  "tau_ca2":150, "i_alpha":1., "i_ca2":Ca0,  'v_reset':-65}
        pop_exc = p.Population(1, p.extra_models.IFCurrExpCa2Concentration, cell_params, label="test")
