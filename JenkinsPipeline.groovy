    ...
    pipeline {
        ...
        stages {
            ...
            stage('Before Install') {
                environment {
                    TRAVIS_BRANCH = pipelineParams.branch
                }
                steps {
            ...
            stage('Run  scripts') {
                steps {
                    ...
                    run_pytest('sPyNNaker8/p8_integration_tests/scripts_test', 1200, 'sPyNNaker8Scripts', 1)
                }
            }
            stage('Unit Tests') {
                steps {
                    run_pytest('SpiNNUtils/unittests', 1200, 'SpiNNUtils', pipelineParams.threads)
                    run_pytest('SpiNNStorageHandlers/tests', 1200, 'SpiNNStorageHandlers', pipelineParams.threads)
                    run_pytest('SpiNNMachine/unittests', 1200, 'SpiNNMachine', pipelineParams.threads)
                    run_pytest('SpiNNMan/unittests SpiNNMan/integration_tests', 1200, 'SpiNNMan', pipelineParams.threads)
                    run_pytest('PACMAN/unittests', 1200, 'PACMAN', pipelineParams.threads)
                    run_pytest('spalloc/tests', 1200, 'spalloc', '1')
                    run_pytest('DataSpecification/unittests', 1200, 'DataSpecification', pipelineParams.threads)
                    run_pytest('SpiNNFrontEndCommon/unittests SpiNNFrontEndCommon/fec_integration_tests', 1200, 'SpiNNFrontEndCommon', pipelineParams.threads)
                    run_pytest('sPyNNaker/unittests', 1200, 'sPyNNaker', pipelineParams.threads)
                    run_pytest('sPyNNaker8/unittests', 1200, 'sPyNNaker8', pipelineParams.threads)
                }
            }
            stage('Test') {
                steps {
