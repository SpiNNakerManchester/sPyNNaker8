...
synaptic_radius = 5  # inhibitory connection radius
...
# print("Max firing rate: " + str(util.compute_max_firing_rate(pop_exc_gc.get_data().segments[0].spiketrains, runtime)))
p.end()
print(data_dir)
