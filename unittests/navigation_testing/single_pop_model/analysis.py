...
def main(input_cells, exc_dir_view):
    ...
    if exc_dir_view:
        with open(DIR + "pop_exc_north_data_spike_train.pkl", 'rb') as f:
            pop_exc_north_spike_train = pickle.load(f)
        with open(DIR + "pop_exc_east_data_spike_train.pkl", 'rb') as f:
            pop_exc_east_spike_train = pickle.load(f)
        with open(DIR + "pop_exc_west_data_spike_train.pkl", 'rb') as f:
            pop_exc_west_spike_train = pickle.load(f)
        with open(DIR + "pop_exc_south_data_spike_train.pkl", 'rb') as f:
    ...
    times = [50, 150, 1000, 1200, int(RUNTIME)-1]
...
def grid_cell_dir_plots(pop_exc_north_spike_train, pop_exc_east_spike_train, pop_exc_west_spike_train, pop_exc_south_spike_train):
    Figure(
